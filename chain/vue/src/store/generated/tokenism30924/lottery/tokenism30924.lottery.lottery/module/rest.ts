...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/tokenism30924/lottery/lottery/lottery
   */
  queryLotteryAll = (params: RequestParams = {}) =>
    this.request<LotteryQueryAllLotteryResponse, RpcStatus>({
      path: `/tokenism30924/lottery/lottery/lottery`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/tokenism30924/lottery/lottery/lottery/{index}
   */
  queryLottery = (index: string, params: RequestParams = {}) =>
    this.request<LotteryQueryGetLotteryResponse, RpcStatus>({
      path: `/tokenism30924/lottery/lottery/lottery/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/tokenism30924/lottery/lottery/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LotteryQueryParamsResponse, RpcStatus>({
      path: `/tokenism30924/lottery/lottery/params`,
      method: "GET",
      format: "json",
      ...params,
    });
